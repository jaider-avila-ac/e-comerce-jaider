 ...
 *
 * El redimensionado/compresión real (crop=limit, width/height, quality=auto:good) se hace del
 * lado de Cloudinary como "incoming transformation" al subir — no hay lógica propia que probar
 * acá para eso (a propósito: se descartó procesar la imagen en Java antes de subir porque
 * ImageIO no decodifica WebP sin una librería nativa extra, poco confiable para desplegar).
 */
